...
function draw(){
    ...
    // Mostrar puntuación - C28
    text("computerScore "+computerScore,50,30)
    text("playerScore "+playerScore,250,30)
    ...
    // La pelota rebota en ambas paletas al usar el grupo - C28
    ball.bounceOff(paddleGroup);

    // Agregar movimiento a las paletas
    ...
    // Reiniciar la pelota al centro cuando salga de la pantalla y aumentar la puntiación - C28
